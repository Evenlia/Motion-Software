...
public final class Constants
{
    ...
    //Elevator
    public static final double ChainRadius = 0.0118925;
    public static final double pulsePerRevolution = 1440.0;
    public static final double eleGearRatio = 2/1;
    public static final double encoderPulseRatio = pulsePerRevolution * eleGearRatio;
    public static final double eleEncoderDistPerPulse = (Math.PI * 2 * ChainRadius) / encoderPulseRatio;
}
