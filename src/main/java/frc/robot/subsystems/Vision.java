...
public class Vision extends SubsystemBase
{
    ...
    private double convert = 0.000851;
    ...
    public void periodic()
    {
        ...
        SmartDashboard.putNumber("debug5", Globals.debug5);
        SmartDashboard.putNumber("debug6", Globals.debug6);
        SmartDashboard.putNumber("debug7", Globals.debug7);
