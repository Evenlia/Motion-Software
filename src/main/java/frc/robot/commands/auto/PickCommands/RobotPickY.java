 ...
 */
public class RobotPickY extends CommandBase
{
    ...
    public RobotPickY(int itemType, double startSpeed, double endSpeed, double maxSpeed)
    {
        /*
        item 0 = chips
             1 = ball
    ...
    public double getItemY(int item){
        ...
        double [] itemCoY = new double[4];

        itemCoY[0] = m_vision.getChips(1);
        itemCoY[1] = m_vision.getBall(1);
        itemCoY[2] = m_vision.getKitkat(1);
        itemCoY[3] = m_vision.getNissin(1);
    ...
    {
        Globals.distCountY += m_setpoint.position;
    }
