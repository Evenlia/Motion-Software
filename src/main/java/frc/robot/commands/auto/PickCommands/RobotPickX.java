 ...
 */
public class RobotPickX extends CommandBase
{
    ...
    public RobotPickX(int itemType, double startSpeed, double endSpeed, double maxSpeed)
    {
        /*
        item 0 = chips
             1 = ball
    ...
    public double getItemX(int item){
        ...
        double [] itemCoX = new double[4];

        itemCoX[0] = m_vision.getChips(0);
        itemCoX[1] = m_vision.getBall(0);
        itemCoX[2] = m_vision.getKitkat(0);
        itemCoX[3] = m_vision.getNissin(0);

        // adds offset of arm to camera
        return itemCoX[item] + 0.1;
    }
    ...
    {
        Globals.distCountX += m_setpoint.position;
    }
